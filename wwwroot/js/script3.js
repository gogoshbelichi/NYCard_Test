...
let select = (s) => document.querySelector(s),
	toArray = (s) => gsap.utils.toArray(s),
		...
		dotArray = [],
		INTERACTIVE = true, //change this for mouse move interaction at the end
		particleArray = [],
		dot = select('.dot'),
		...
		currDotValue = null,
		nextDotValue = null,
		colorArray = ["fbf8cc","fde4cf","ffcfd2","f1c0e8","cfbaf0","a3c4f3","90dbf4","8eecf5","98f5e1","b9fbc0"],
...
pointArray.forEach((i, c) => {
	...
	let p = new Particle(i.x, i.y, clone, c, colorArray[c % colorArray.length], null);
